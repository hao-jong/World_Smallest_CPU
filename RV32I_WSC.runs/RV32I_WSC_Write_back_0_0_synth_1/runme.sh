...
HD_PWD='C:/FPGA_project/RV32I_WSC/RV32I_WSC.runs/RV32I_WSC_Write_back_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RV32I_WSC_Write_back_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RV32I_WSC_Write_back_0_0.tcl
