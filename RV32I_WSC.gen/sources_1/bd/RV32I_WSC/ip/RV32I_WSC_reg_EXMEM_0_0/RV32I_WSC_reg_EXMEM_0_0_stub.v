...
module RV32I_WSC_reg_EXMEM_0_0(clk, rst, branch_in, memwrite_in, memread_in, 
  memtoreg_in, regwrite_in, next_pc_cal_in, branch_ctrl_in, alu_result_in, read_data2_in, 
  write_register_in, memtoreg, regwrite, branch, memwrite, memread, next_pc_cal, branch_ctrl, 
  alu_result, read_data2, write_register)
/* synthesis syn_black_box black_box_pad_pin="rst,branch_in,memwrite_in,memread_in,memtoreg_in,regwrite_in,next_pc_cal_in[31:0],branch_ctrl_in,alu_result_in[31:0],read_data2_in[31:0],write_register_in[4:0],memtoreg,regwrite,branch,memwrite,memread,next_pc_cal[31:0],branch_ctrl,alu_result[31:0],read_data2[31:0],write_register[4:0]" */
