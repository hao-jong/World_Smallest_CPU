...
architecture STRUCTURE of RV32I_WSC_Instruction_Fetch_0_0_Instruction_Fetch is
  ...
  signal \program_counter[31]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \program_counter_reg[31]_i_1_n_2\ : STD_LOGIC;
  signal \program_counter_reg[31]_i_1_n_3\ : STD_LOGIC;
  signal \program_counter_reg[31]_i_1_n_5\ : STD_LOGIC;
  signal \program_counter_reg[31]_i_1_n_6\ : STD_LOGIC;
  signal \program_counter_reg[31]_i_1_n_7\ : STD_LOGIC;
  ...
  signal \NLW_program_counter_reg[31]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_program_counter_reg[31]_i_1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute ADDER_THRESHOLD of \program_counter_reg[31]_i_1\ : label is 11;
...
\program_counter[31]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\program_counter_reg[29]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => \program_counter_reg[31]_i_1_n_7\,
...
\program_counter_reg[30]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => \program_counter_reg[31]_i_1_n_6\,
...
\program_counter_reg[31]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => \program_counter_reg[31]_i_1_n_5\,
      Q => \^program_counter\(31),
      R => rst
    );
\program_counter_reg[31]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => \program_counter_reg[28]_i_1_n_0\,
      CO(3 downto 2) => \NLW_program_counter_reg[31]_i_1_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \program_counter_reg[31]_i_1_n_2\,
      CO(0) => \program_counter_reg[31]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \NLW_program_counter_reg[31]_i_1_O_UNCONNECTED\(3),
      O(2) => \program_counter_reg[31]_i_1_n_5\,
      O(1) => \program_counter_reg[31]_i_1_n_6\,
      O(0) => \program_counter_reg[31]_i_1_n_7\,
      S(3) => '0',
      S(2) => \program_counter[31]_i_2_n_0\,
      S(1) => \program_counter[31]_i_3_n_0\,
      S(0) => \program_counter[31]_i_4_n_0\
    );
