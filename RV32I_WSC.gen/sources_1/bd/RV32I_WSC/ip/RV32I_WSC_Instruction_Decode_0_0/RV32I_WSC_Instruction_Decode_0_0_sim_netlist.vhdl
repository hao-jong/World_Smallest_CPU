...
architecture STRUCTURE of RV32I_WSC_Instruction_Decode_0_0_Controller is
  ...
  signal \alusrc_reg[1]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \aluop_reg[0]_i_1\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \aluop_reg[1]_i_1\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \alusrc_reg[0]_i_1\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \alusrc_reg[1]_i_1\ : label is "soft_lutpair0";
  attribute XILINX_LEGACY_PRIM of branch_reg : label is "LD";
  attribute XILINX_TRANSFORM_PINMAP of branch_reg : label is "VCC:GE GND:CLR";
  ...
  attribute SOFT_HLUTNM of memwrite_reg_i_1 : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \pc_vs_rs1_con_reg[0]_i_1\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \pc_vs_rs1_con_reg[1]_i_1\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of regwrite_reg_i_1 : label is "soft_lutpair3";
begin
...
\alusrc_reg[0]\: unisim.vcomponents.LDCE
    generic map(
      ...
      G => \alusrc_reg[1]_i_2_n_0\,
      GE => '1',
      Q => alusrc(0)
    );
\alusrc_reg[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AFB0"
    )
        port map (
...
\alusrc_reg[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4000"
    )
        port map (
...
\alusrc_reg[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00220022808A0000"
    )
        port map (
...
\pc_vs_rs1_con_reg[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"BAAA"
    )
        port map (
...
\pc_vs_rs1_con_reg[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00004000"
    )
        port map (
