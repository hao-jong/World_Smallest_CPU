...
#
# Script generated by Vivado on Mon Feb 03 15:26:18 +0900 2025
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : RV32I_WSC.sh
...
#
# Usage        : RV32I_WSC.sh
#                RV32I_WSC.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                RV32I_WSC.sh [-reset_run]
#                RV32I_WSC.sh [-reset_log]
#                RV32I_WSC.sh [-help]
#
...
# script info
echo -e "RV32I_WSC.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./RV32I_WSC.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot RV32I_WSC xil_defaultlib.RV32I_WSC xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim RV32I_WSC -key {Behavioral:sim_1:Functional:RV32I_WSC} -tclbatch cmd.tcl -protoinst "protoinst_files/RV32I_WSC.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb RV32I_WSC.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./RV32I_WSC.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: RV32I_WSC.sh [-help]\n\
Usage: RV32I_WSC.sh [-step]\n\
Usage: RV32I_WSC.sh [-lib_map_path]\n\
Usage: RV32I_WSC.sh [-reset_run]\n\
Usage: RV32I_WSC.sh [-reset_log]\n\
Usage: RV32I_WSC.sh [-keep_index]\n\
Usage: RV32I_WSC.sh [-noclean_files]\n\n\
