...
#                script (type 'RV32I_WSC.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.RV32I_WSC xil_defaultlib.glbl -o RV32I_WSC_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./RV32I_WSC_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key RV32I_WSC_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc RV32I_WSC_simv.daidir vcs_lib c.obj)
